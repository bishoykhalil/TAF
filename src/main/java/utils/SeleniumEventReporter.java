...
public class SeleniumEventReporter implements WebDriverEventListener {
	...
	LoggerClass.logMessage("Finding element --> " + by);
    }

    @Override
    @Step("Selenium logs: Successfully found element")
    public void afterFindBy(By by, WebElement webElement, WebDriver webDriver) {
	LoggerClass.logMessage("Successfully found element --> " + by);
    }

    @Override
    @Step("Selenium logs: Clicking on element")
    public void beforeClickOn(WebElement webElement, WebDriver webDriver) {
	LoggerClass.logMessage("Clicking on element: " + webElement);
    }

    @Override
    @Step("Selenium logs: Successfully Clicked on element")
    public void afterClickOn(WebElement webElement, WebDriver webDriver) {
	LoggerClass.logMessage("Successfully clicked on element: " + webElement);
    }

    @Override
    @Step("Selenium logs: Changing value of Element")
    public void beforeChangeValueOf(WebElement webElement, WebDriver webDriver, CharSequence[] charSequences) {
	LoggerClass.logMessage("Changing value of element: " + webElement);
    }

    @Override
    @Step("Selenium logs: Successfully changed the value of element")
    public void afterChangeValueOf(WebElement webElement, WebDriver webDriver, CharSequence[] charSequences) {
	LoggerClass.logMessage("Successfully changed the value of element: " + webElement);
    }
	...
	LoggerClass.logMessage("Getting text of element: " + webElement);
    }

    @Override
    public void afterGetText(WebElement webElement, WebDriver webDriver, String text) {
	LoggerClass.logMessage("Successfully got the text of the element --> " + text);
    }
}
